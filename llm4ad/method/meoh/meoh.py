...
class MEoH:
    ...
    def _sample_evaluate_register(self, prompt, max_retries = 3):
        ...
        self._population.register_function(func) # when calling this, also update the generation or iteration
    ...
    def _thread_do_evolutionary_operator(self):
        while self._continue_sample():
            try:
                ...
                print("Finishing getting e1 prompt")
                if self._debug_mode:
                    print(prompt)
                    input()
                ...
                if self._use_e2_operator:
                    ...
                    print("Finishing getting e2 prompt")
                    if self._debug_mode:
                        print(prompt)
                        input()
                ...
                if self._use_m1_operator:
                    ...
                    print("Finishing getting m1 prompt")
                    if self._debug_mode:
                        print(prompt)
                        input()
                ...
                if self._use_m2_operator:
                    ...
                    print("Finishing getting m2 prompt")
                    if self._debug_mode:
                        print(prompt)
                        input()
